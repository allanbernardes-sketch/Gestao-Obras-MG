    ...
    return (
      ...
      >
        ...
        <div className="pt-2 border-t border-slate-100 space-y-1.5 text-left" onClick={(e) => e.stopPropagation()}>
          ...
          {(!isReadOnly && (perfilUsuario === 'gestor_paf' || (perfilUsuario === 'admin' || perfilUsuario === 'diretor_dore') || perfilUsuario === 'analista_dore')) ? (
            <div className="space-y-1">
              ...
              {(perfilUsuario === 'gestor_paf' || (perfilUsuario === 'admin' || perfilUsuario === 'diretor_dore')) && sol.analistaAtribuido && (
                <button
                  type="button"
